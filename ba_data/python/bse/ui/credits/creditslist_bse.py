...
class CreditsBSEWindow(bui.Window):
    ...
    def __init__(self, transition: str = 'in_right', origin_widget: bui.Widget | None = None):
    ...
    def _save_state(self) -> None:
        ...
        # Try saving!
        try: bui.app.ui_v1.window_states[type(self)] = sel_name
        except Exception: bui.print_exception(f'Error saving state for "{self}" with "{sel} / {sel_name}".')
        
    def _restore_state(self) -> None:
        sel_name = bui.app.ui_v1.window_states.get(type(self)); sel = None
        ...
        # Try restoring!
        try: bui.containerwidget(edit=self._root_widget, selected_child=sel)
        except Exception: bui.print_exception(f'Error saving state for "{self}" with "{sel} / {sel_name}".')
        
    def _contributors(self) -> None:
        # pylint: disable=cyclic-import
        from bse.ui.credits.credits_contributors import CreditsContributorsWindow
        self._save_state()
