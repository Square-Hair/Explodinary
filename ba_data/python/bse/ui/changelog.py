...
from bse import logs
changelogs_keys: list = []

for key in logs.changelogs.keys():
...
class ChangelogWindow(bui.Window):
    ...
    def __init__(self, origin_widget: bui.Widget | None = None):
        ...
        txt = logs.changelogs[changelogs_keys[csel]]
        ...
        self.navbtn: list = []
        for x in range(2):
            self.navbtn.append(bui.buttonwidget(
                parent=self._root_widget,
                position=npos,
                size=(45,80),  
                scale=1,
        ...
        bui.buttonwidget(edit=backbtn,
                        down_widget=scroll)
        
        bui.widget(edit=scroll,
