...
splashText = [
    ...
    "Ah, that's how we're gonna port to 1.7.20!",
    "you do ip",
    "you do mc",
    "you do campaign",
    "is that SoK explodinar?",
    "Totally not foreshadowing!",
    "From the creators of Eon!",
    "...Square who?",
    "*unbombs your jump*",
    "We're on our evil arc",
    ...
    "unhypes your server",
    "claypocalypse when",
    "don't tell sok I updated this",
    "paypal me 500$ dollars",
    "Today's infatuation!",
    "Next update 2029",
