...
class Particle(ba.Actor):
    def __init__(self,
        ...
        ba.timer(a['time']+a['in'], self._fade_out)
    ...
    def _fade_out(self):
        if self.node:
            ...
            ba.timer(self.attrs['fade'], ba.Call(self.handlemessage, ba.DieMessage()))
...
class bseVFX:
    def __init__(self,
        ...
        self.pos = position
        self._mode = mode
        p = ba.app.config.get("BSE: Custom Particles", 'Max')
        ...
        if mode == 'vitalbomb':
            ...
            self._generate('particlePetal', 'vitalBomb',
                           ...
                           body_scale=0.77, model_scale=1.66, shadow_size=0.005,
            ...
            self._generate('particleLeaf', 'theBeginningLevelColor',
                           ...
                           body_scale=0.77, model_scale=[0.7,1.1], shadow_size=0.005, reflection_scale=0.7,
            ...
            self._generate('bomb', 'null',
                           ...
                           body_scale=0.1, model_scale=0.3, shadow_size=0.005,
            ...
            self._generate('bomb', 'null',
                           ...
                           body_scale=0.1, model_scale=[0.39,0.56], shadow_size=0.005,
            ...
            self._generate('bomb', 'null',
                           position, velocity, 'sphere', color=(2,2,2),
                           iterations=itr, spread=1.2,
                           body_scale=0.1, model_scale=0.4, shadow_size=0.005,
            ...
            self._generate('bomb', 'null',
                           ...
                           body_scale=0.1, model_scale=0.4, shadow_size=0.005, reflection_scale=0,
                           lifespan=0, lifefade=1.22,
                           )
            ...
            self._generate('bomb', 'null',
                           ...
                           body_scale=0.22, model_scale=0.4, shadow_size=0.005, reflection_scale=0,
            ...
            self._generate('bomb', 'null',
                           ...
                           body_scale=0.02, model_scale=0.12, shadow_size=0.005, reflection_scale=2,
            ...
            self._generate('particleConfetti', texlist,
                           ...
                           body_scale=0.3, model_scale=[0.77, 1], shadow_size=0.005,
    ...
    def _generate(self,
        ...
        for i in range(iterations):
            ...
            # Choose a random model and texture if a list is assigned to them
            amodel = random.choice(model) if type(model) is list else model
            atexture = random.choice(texture) if type(texture) is list else texture
            
            # Get model / texture if the values are strings instead of their respective type
            if type(amodel) is str:     amodel = ba.getmodel(amodel)
            if type(atexture) is str:   atexture = ba.gettexture(atexture)
