...
class CreditsTestersWindow(ba.Window):
    ...
    def __init__(self, origin_widget: ba.Widget | None = None):
        ...
        #PFPs
        self.breaker_tex = ba.gettexture('pfpBreaker')
        self.corrolot_tex = ba.gettexture('pfpCorro')
        self.davii_tex = ba.gettexture('pfpDavii')
        self.nox_tex = ba.gettexture('pfpNox')
        ...
        ba.textwidget(
            ...
            size=(width, 30),
            text=ba.Lstr(resource=f'{self._r}.btn.test'),
            h_align='center',
        ...
        self._breakerYT_button = ba.buttonwidget(
          parent=container,
          position=(215, 310),
          color=(0.8, 0.3, 0.25),
          size=(100, 35),
          ...
          on_activate_call=ba.Call(
              ba.open_url, 'https://www.youtube.com/@breaker6501'
          ),
        )
        #Corrolot
        ba.imagewidget(
        ...
        self._corroYT_button = ba.buttonwidget(
          parent=container,
          position=(215, 225),
          color=(0.8, 0.3, 0.25),
          size=(100, 35),
          label='YT Channel',
          on_activate_call=ba.Call(
              ba.open_url, 'https://www.youtube.com/@corrolot'
          ),
        )
        #Davii
        ba.imagewidget(
        ...
        self._daviiYT_button = ba.buttonwidget(
          parent=container,
          position=(215, 150),
          color=(0.8, 0.3, 0.25),
          size=(100, 35),
          label='YT Channel',
          on_activate_call=ba.Call(
              ba.open_url, 'https://www.youtube.com/@DaviiWasTaken'
          ),
        )
        #Noxen
        ba.imagewidget(
        ...
        self._noxYT_button = ba.buttonwidget(
          parent=container,
          position=(215, 65),
          color=(0.8, 0.3, 0.25),
          size=(100, 35),
          label='YT Channel',
          on_activate_call=ba.Call(
              ba.open_url, 'https://www.youtube.com/@NoxenZero'
          ),
        )
