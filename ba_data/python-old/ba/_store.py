...
def get_store_items() -> dict[str, dict]:
    ...
    if _ba.app.store_items is None:
        ...
        _ba.app.store_items = {
            ...
            #BSE
            'characters.helpy_bse': {'character': 'Helpy'},
            'characters.amigo_bse': {'character': 'Spencer'},
            'merch': {},
            'pro': {},
            ...
            'icons.explodinary': {'icon': _ba.charstr(SpecialChar.EXPLODINARY_LOGO)},
        }
...
def get_store_layout() -> dict[str, list[dict[str, Any]]]:
    ...
    store_layout['characters'].append({'title':'explodinary.bseCharactersText','items':['characters.helpy_bse', 'characters.amigo_bse']})
