...
class App:
    ...
    def on_app_launch(self) -> None:
        ...
        for maptype in [
            ...
            stdmaps.BigG,
            stdmaps.Roundabout,
            stdmaps.ExplodinaryRoundabout,
            stdmaps.MonkeyFace,
            stdmaps.ZigZag,
            stdmaps.ThePad,
            stdmaps.ExplodinaryThePad,
            stdmaps.DoomShroom,
            stdmaps.SmoothShroom,
            stdmaps.LakeFrigid,
            stdmaps.TipTop,
            stdmaps.CragCastle,
            stdmaps.TowerD,
            ...
            stdmaps.StepRightUp,
            stdmaps.ExplodinaryStepRightUp,
            stdmaps.Courtyard,
            stdmaps.Rampage,
            stdmaps.BlockFortress,
            stdmaps.Morning,
            stdmaps.HoveringWood,
            stdmaps.SpaceOdyssey,
            stdmaps.OnslaughtArena,
            stdmaps.Walleyville,
            stdmaps.WhereEaglesDare,
            stdmaps.Cardfoart,
            stdmaps.BetweenTheTeams,
            stdmaps.SculpeyForest,
            stdmaps.ChopChop,
            stdmaps.SoccerStadium,
            stdmaps.ExplodinaryRunaround,
            stdmaps.Snowhold,
            stdmaps.BaboonFace,
            stdmaps.PathwayPandemonium,
            stdmaps.SourFlower,
            stdmaps.FuseCruise,
            stdmaps.Sunset,
            stdmaps.RouteRoulette,
            stdmaps.Hub,
            stdmaps.Tree,
            stdmaps.ClayishDonut,
            #Kablooya Maps
            stdmaps.Kablooya,
            stdmaps.EndlessKablooya,
            stdmaps.TowerS,
            stdmaps.EndlessS,
            #Explodinary Campaign Maps
            stdmaps.TheBeginning,
            stdmaps.Grotto,
            stdmaps.MysteriousSwamp,
            stdmaps.AlpineGateway,
            stdmaps.MountChill,
            stdmaps.HotAirBalloon,
            stdmaps.Blockland,
            stdmaps.Confrontation,
            stdmaps.BombPoem
        ]:
    ...
    def launch_hub_game(
        ...
        def _fade_end() -> None:
            from ba import _hubsession

            try:
                _ba.new_host_session(_hubsession.HubSession)
            except Exception:
                from ba import _error
