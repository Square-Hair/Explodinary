...
@dataclass
class TNTFreezeMessage:
    """Tells an object to become frozen for 6 seconds.

    Category: **Message Classes**

    As seen in the effects of an TNT.
    """
...
@dataclass
class VitalMessage:
    """Tells the spaz to become vital.

    Category: **Message Classes**

    As seen in the effects of a vital ba.Bomb.
    """
    def __init__(
        self,
...
class UnvitalMessage:
    """Tells the spaz to stop being vital.

    Category: **Message Classes**

    As seen in the effects of an vital ba.Bomb.
    """

@dataclass
class VitaminMessage:
    """Tells the spaz to be vital with vitamin.

    Category: **Message Classes**

    As seen in the effects of a vitamin.
    """

@dataclass
class CharmMessage:
    """Heal Spaz because of charm!

    Category: **Message Classes**

    As seen in the effects of a Clay Charm.
    """


@dataclass
class JumpyMessage:
    """Tells the spaz to JUUUMP!

    Category: **Message Classes**

    As seen in the effects of a jump-pad.
    """

@dataclass
class SlingMessage:
    """Tells the spaz to boost!

    Category: **Message Classes**

    As seen in the effects of a speed-pad.
    """
    
@dataclass
class ToxicMessage:
    """Tells the spaz to become toxic.

    Category: **Message Classes**

    As seen in the effects of an toxic ba.Bomb.
    """
    
@dataclass
class HealthyMessage:
    """Tells the spaz to become healthy after being poisoned..
...
class PoisonedMessage:
    """Tells an object to become poisoned.
