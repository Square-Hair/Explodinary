...
def get_all_tips() -> list[str]:
    ...
    tips = [
        ...
        #BSE
        (
            'Boxing Gloves are great if you time your punches right.'
        ),
        (
        ...
        (
            ...
            'They give vital effects to everyone, so be careful to not buff your enemies by accident!'
        ),
        (
            'TNTs spawn in this order: Classic, Ice, Toxic, Glue.'
        ),
        (
            'Steam Bomb\'s blast can be indicated by the engine sound speed.'
        ),
        (
            'Toxic Bomb doesn\'t destroy powerups, but leaves them poisoned.'
        ),
        (
    ...
    if not app.iircade_mode:
        tips += [
            ...
            'visuals in the graphics settings, or turning off More \n'
            'Particles option in BSE Settings.'
        ]
    if (
        ...
        tips += [
            (
                ...
                'battery power,\nturn down "Visuals", "Resolution" '
                'in Settings->Graphics, or turn off More Particles\n'
                'in Settings->BSE Settings'
            ),
        ]
