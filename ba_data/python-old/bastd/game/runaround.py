...
class RunaroundGame(ba.CoopGameActivity[Player, Team]):
    ...
    def on_begin(self) -> None:
        ...
        if self._preset in {Preset.PRO, Preset.PRO_EASY, Preset.TOURNAMENT}:
            self._exclude_powerups = ['curse', 'tacky_bombs', 'glue_mines', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch', 'dash']
            self._have_tnt = True
            self._waves = [
                Wave(
                    entries=[
            ...
            self._exclude_powerups = ['tacky_bombs', 'glue_mines', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch', 'dash']
            self._have_tnt = True
            self._waves = [
                Wave(
                    entries=[
