...
from bastd.actor.bomb import ClassicTNTSpawner
...
class OnslaughtGame(ba.CoopGameActivity[Player, Team]):
    ...
    def __init__(self, settings: dict):
        ...
        self._tntspawner: ClassicTNTSpawner | None = None
    ...
    def on_begin(self) -> None:
        ...
        if self._preset in {Preset.TRAINING, Preset.TRAINING_EASY}:
            ...
            self._have_tnt = False
            self._excluded_powerups = ['curse', 'land_mines', 'tacky_bombs', 'glue_mines', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch', 'dash']
            self._waves = [
                Wave(
                    base_angle=195,
                    entries=[
            ...
            self._have_tnt = False
            self._excluded_powerups = ['curse', 'tacky_bombs', 'glue_mines', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch', 'dash']
            self._waves = [
                Wave(
                    entries=[
            ...
            self._have_tnt = True
            self._excluded_powerups = ['tacky_bombs', 'glue_mines', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch', 'dash']
            self._waves = [
                Wave(
                    entries=[
    ...
    def _do_tnt(self): self._tntspawner = ClassicTNTSpawner(position=self._tntspawnpos)
