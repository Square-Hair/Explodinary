...
class FootballCoopGame(ba.CoopGameActivity[Player, Team]):
    ...
    def on_begin(self) -> None:
        ...
        if self._preset in ['rookie', 'rookie_easy']:
            self._exclude_powerups = ['curse', 'tacky_bombs', 'glue_miness', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch']
            self._have_tnt = False
            abot = (
            ...
            self._exclude_powerups = ['tacky_bombs', 'glue_miness', 'cluster_bombs', 'lite_mines', 'steampunk_bombs', 'toxic_bombs', 'vital_bombs', 'present', 'clouder_bombs', 'flutter_mines', 'fly_punch']
            self._have_tnt = True
        ...
        if self._have_tnt:
            self._tntspawner = ClassicTNTSpawner(position=(0, 1, -1))
