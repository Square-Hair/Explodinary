        ...
        try:
            ...
            self._entries = [
                ...
                SpawnSpaz(
                    ...
                    make_current=False,
                    color=(1, 1, 0.4),
                    name=ba.Lstr(resource=f'explodinary.append.playModes.randomName1Text'),
                ),
                Move(-1.0, 0),
                DelayOld(1050),
                Move(0, -0.01),
                ...
                Text(
                    ba.Lstr(
                        ...
                        subs=[
                            (
                                '${NAME}',
                                ba.Lstr(resource=f'explodinary.append.playModes.randomName1Text'),
                            )
                        ],
                    )
                ...
                SpawnSpaz(
                    ...
                    make_current=False,
                    color=(0.9, 0.5, 1.0),
                    name=ba.Lstr(resource=f'explodinary.append.playModes.randomName2Text'),
                ),
                DelayOld(1800),
                Text(
                ...
                SpawnSpaz(
                    ...
                    name=ba.Lstr(resource=f'explodinary.append.playModes.randomName3Text'),
                ),
                DelayOld(100),
                ...
                Text(
                    ba.Lstr(
                        ...
                        subs=[
                            (
                                '${NAME}',
                                ba.Lstr(resource=f'explodinary.append.playModes.randomName3Text'),
                            )
                        ],
                    )
                ),  # whoops sorry bill
                ...
                Text(
                    ba.Lstr(
                        ...
                        subs=[
                            (
                                '${NAME}',
                                ba.Lstr(resource=f'explodinary.append.playModes.randomName4Text'),
                            )
                        ],
                    )
                ...
                SpawnSpaz(
                    ...
                    make_current=False,
                    color=(0.4, 1.0, 0.7),
                    name=ba.Lstr(resource=f'explodinary.append.playModes.randomName4Text'),
                ),
                DelayOld(1000),
                ...
                SpawnSpaz(
                    ...
                    make_current=False,
                    color=(0.3, 0.8, 1.0),
                    name=ba.Lstr(resource=f'explodinary.append.playModes.randomName5Text'),
                ),
                DelayOld2(1000),
                Move(-1, 0),
                DelayOld2(1800),
