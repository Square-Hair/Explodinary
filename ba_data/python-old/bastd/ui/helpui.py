...
class HelpWindow(ba.Window):
    ...
    def __init__(
        ...
        ba.textwidget(
            ...
            size=(width, 25),
            text='BombSquad: Explodinary Help',
        ...
        self._sub_width = 660
        #here I change the scroll window size
        self._sub_height = (
            2910
        ...
        txt = ba.Lstr(resource=f'explodinary.append.{self._r}.intro00').evaluate()
        txt_scale = 1.4
        txt_maxwidth = 480
        ba.textwidget(
        ...
        if (
            ...
            v -= spacing * 70.0
            txt = ba.Lstr(resource=f'explodinary.append.{self._r}.intro01').evaluate()
            ba.textwidget(
                parent=self._subcontainer,
                position=(h, v),
                size=(0, 0),
            ...
            v -= spacing * 65.0 + getres(self._r + '.someDaysExtraSpace')
            txt_scale = 1.0
            txt = ba.Lstr(resource=f'explodinary.append.{self._r}.intro02').evaluate()
            ba.textwidget(
                parent=self._subcontainer,
                position=(h, v),
                size=(0, 0),
            ...
            v -= spacing * 60.0 + getres(
                self._r + '.orPunchingSomethingExtraSpace'
            )
            txt_scale = 1.5
            txt = ba.Lstr(resource=f'explodinary.append.{self._r}.intro03').evaluate()
            ba.textwidget(
                parent=self._subcontainer,
                position=(h, v + 5),
                size=(0, 0),
            ...
            txt = ba.Lstr(
                resource=f'explodinary.append.{self._r}.friendsGoodText',
        ...
        txt = ba.Lstr(resource=f'explodinary.append.{self._r}.runInfoText').evaluate()
        ...
        for tex in [
            ...
            name = ba.Lstr(resource             = f'explodinary.append.{self._r}.{tex}NameText',
                           fallback_resource    = self._r + '.' + tex + 'NameText')
            
            desc = ba.Lstr(resource             = f'explodinary.append.{self._r}.{tex}DescriptionText',
                           fallback_resource    = self._r + '.' + tex + 'DescriptionText')
        ...
        txt = ba.Lstr(resource=f'explodinary.append.{self._r}.TNTsText').evaluate()
        txt_scale = 1.4
        txt_maxwidth = 480
        ba.textwidget(
            parent=self._subcontainer,
        ...
        v -= spacing * 50.0
        txt_scale = getres(self._r + '.powerupsSubtitleTextScale')
        txt = ba.Lstr(resource=f'explodinary.append.{self._r}.TNTsSubtitleText').evaluate()
        ba.textwidget(
            parent=self._subcontainer,
            position=(h - 10, v - 5),
            size=(0, 0),
        ...
        self._discord_button = ba.buttonwidget(
          parent=self._subcontainer,
          position=(75, 15),
          color=(0.35, 0.35, 1),
          size=(500, 90),
          label=ba.Lstr(
              resource=f'explodinary.append.{self._r}.discordText'),
          on_activate_call=ba.Call(
              ba.open_url, 'https://discord.gg/tBDQDCbS9A'
          ),
        )
