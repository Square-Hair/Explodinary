...
class CoopBrowserWindow(ba.Window):
    ...
    def _on_tournament_info_press(self) -> None:
        ...
        txt = ba.Lstr(resource='explodinary.noTournamentsText')
        ConfirmWindow(
            txt,
            cancel_button=False,
            width=550,
    ...
    def _refresh(self) -> None:
        ...
        txt = ba.Lstr(
            resource='explodinary.tournamentsText', fallback_resource='tournamentText'
        ).evaluate()
        ...
        ba.imagewidget(
            parent=w_parent,
            position=(h_base + 330, v + 0),
            size=(80, 60),
            texture=self.point_tex,
            opacity=0.8,
        )
