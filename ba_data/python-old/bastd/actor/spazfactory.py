...
class SpazFactory:
    ...
    impact_sounds_giant: Sequence[ba.Sound]
    """A tuple of ba.Sound-s for when a ba.Spaz hits something very,
        very aggressively."""
    ...
    punch_sound_crit: ba.Sound
    """A critical punch ba.Sound."""

    swish_sound: ba.Sound
    """A punch swish ba.Sound."""
    
    swish_boxing_sound: ba.Sound
    """A punch swish when spaz has boxing gloves ba.Sound."""
    
    swish_flying_sound: ba.Sound
    """A punch swish when spaz has flying gloves ba.Sound."""
    ...
    splatter_extreme_sound: ba.Sound
    """A satisfying ba.Sound for when a ba.Spaz blows up extremely."""
    
    curse_heal_sound: ba.Sound
    """The ba.Sound for the sound when Spaz heals his curse."""
    
    dash_sound: ba.Sound
    """A standard dash ba.Sound."""
    
    vitalup_sound: ba.Sound
    """A vital ba.Sound."""
    
    vitaldown_sound: ba.Sound
    """An unvital ba.Sound."""
    ...
    def __init__(self) -> None:
        ...
        #CHARACTERS MADE OF FLESH
        self.impact_sounds_medium = (
            ba.getsound('impactMedium'),
            ba.getsound('impactMedium2'),
            ba.getsound('impactMedium3'),
            ba.getsound('impactMedium4'),
            ba.getsound('impactMedium5'),
        )
        ...
        self.impact_sounds_giant = (
            ba.getsound('impactGiant'),
            ba.getsound('impactGiant2',),
            ba.getsound('impactGiant3'),
            ba.getsound('impactGiant4'),
            ba.getsound('impactGiant5'),
            ba.getsound('impactGiant6'),
        )
        #CHARACTERS MADE OF METAL
        self.impact_metal_sounds_soft = (ba.getsound('impactMediumMetal1'),
                                ba.getsound('impactMediumMetal2'))
        self.impact_metal_sounds_medium = (ba.getsound('impactHardMetal1'),
                                ba.getsound('impactHardMetal2'))
        self.impact_metal_sounds_hard = (ba.getsound('impactGiantMetal1'),
                                ba.getsound('impactGiantMetal2'))
        #CHARACTERS MADE OF CARDBOARD (WELL, JUST SPLASH..)
        self.impact_cardboard_sounds_soft = (ba.getsound('impactMediumCardboard1'),
                                ba.getsound('impactMediumCardboard2'))
        self.impact_cardboard_sounds_medium = (ba.getsound('impactHardCardboard1'),
                                ba.getsound('impactHardCardboard2'))
        self.impact_cardboard_sounds_hard = (ba.getsound('impactGiantCardboard1'),
                                ba.getsound('impactGiantCardboard2'))                        
        ...
        self.punch_sound_ultra = ba.getsound('punchSplatter')
        self.swish_sound = ba.getsound('punchSwish')
        self.swish_boxing_sound = ba.getsound('punchBoxingSwish')
        self.swish_flying_sound = ba.getsound('flyingGlovesSound')
        self.block_sound = ba.getsound('block')
        self.shatter_sound = ba.getsound('shatter')
        self.splatter_sound = ba.getsound('splatter')
        self.splatter_extreme_sound = ba.getsound('splatterExtreme')
        self.curse_heal_sound = ba.getsound('curseHeal')
        self.dash_sound = ba.getsound('dash')
        self.vitalup_sound = ba.getsound('vitalBuff')
        self.vitaldown_sound = ba.getsound('vitalDebuff')
        self.electrip_sound = ba.getsound('electrip')
        ...
        self.spaz_material.add_actions(
            ...
            actions=(
                ...
                ('roll_sound', self.skid_sound, 20.0, 10),
            ),
        )
        ...
        self.delin_sound = ba.getsound("delin")
        ...
        self.punch_power_scale_gloves = (
            ba.internal.get_v1_account_misc_read_val('rppg', 1.9)
        )
